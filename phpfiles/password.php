    ...
    <body>
        ...
        <p>This application takes a 32-character MD5 hash and attempts to brute-force the original 4-digit PIN (0000–9999).</p>

        <form>
            <input type="text" name="md5" size="40" placeholder="Enter MD5 hash here">
